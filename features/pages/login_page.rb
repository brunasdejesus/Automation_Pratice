module Pages
  class LoginPage < SitePrism::Page         # Está herdando os métodos de SitePrism::Page
    set_url '/index.php?controller=authentication&back=my-account'                         # O usuário está sendo direcionado para a URL passada no documento env.rb (Vou explicar melhor quando falar desse documento)   
